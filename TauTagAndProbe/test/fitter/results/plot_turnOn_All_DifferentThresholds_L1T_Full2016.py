...
plots = []
plots.append(TurnOnPlot.TurnOnPlot(TriggerName="L1T #tau"))
plots[-1].name = "turnOn_All"
# plots[-1].xRange = (10,109.9)
plots[-1].xRange = (10,149.9)
...
#open turn on file
inputFile = ROOT.TFile.Open("Full2016/fitOutput.root")

histo_26GeV = inputFile.Get("histo_Stage2_26")
histo_26GeV.__class__ = ROOT.RooHist
histo_30GeV = inputFile.Get("histo_Stage2_30")
histo_30GeV.__class__ = ROOT.RooHist
histo_34GeV = inputFile.Get("histo_Stage2_34")
histo_34GeV.__class__ = ROOT.RooHist

fit_26GeV   = inputFile.Get("fit_Stage2_26")
fit_26GeV.__class__ = ROOT.RooCurve
fit_30GeV   = inputFile.Get("fit_Stage2_30")
fit_30GeV.__class__ = ROOT.RooCurve
fit_34GeV   = inputFile.Get("fit_Stage2_34")
